...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <h1 class="red-text">User Sign Up Form</h1>
            ...
            <div id="signup_form">
                <form id="user_signup_form" name="UserSignUp" method="post" action="UserSignUp">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" id="login_id" placeholder="Create Name ..." name="login_id" maxlength="10">
                    </div>
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="password" class="form-control" id="login_pwd" placeholder="Create Password ..." name="login_pwd">
                    </div>

                    <div>&nbsp;</div>
                    <button id="submit_btn" type="submit" class="btn btn-success btn-lg btn-block">Sign Up</button>
                </form>
            </div>

            <div>&nbsp;</div>

            <a class="btn btn-warning btn-lg btn-block" href="index.jsp">Back</a>
